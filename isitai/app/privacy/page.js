    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        {[
          ...
          { title: 'Your rights', content: 'Since we do not store personal data linked to individuals, most data subject requests do not apply. If you believe we hold data about you, or if you have any privacy concern, contact us at ' + process.env.PRIVACY_EMAIL + ' and we will respond within 5 business days.' },
          ...
          { title: 'Contact', content: 'Questions about this policy? Email us at ' + process.env.PRIVACY_EMAIL + '. We are committed to being transparent and responsive about how we handle your data.' },
        ].map((section, i) => (
